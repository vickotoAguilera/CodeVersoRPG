...
class PantallaItems:
    ...
    def draw(self, pantalla):
        ...
        dibujar_ventana_glass(pantalla, self.caja_desc_rect, "Descripcion", 
                             obtener_color_acento("items"), alpha=230)
        dibujar_ventana_glass(pantalla, self.caja_actor_rect, "Usuario", 
                             obtener_color_acento("items"), alpha=230)
        dibujar_ventana_glass(pantalla, self.caja_items_rect, "Items Disponibles", 
                             obtener_color_acento("items"), alpha=230)
        ...
        start_y_opciones = self.caja_items_rect.y + 60  # Ajustado para glassmorphism
