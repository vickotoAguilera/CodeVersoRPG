...
class PantallaListaHabilidades:
    ...
    def draw(self, pantalla):
        ...
        if not self.lista_habilidades_mostradas:
            ...
            # Crear una superficie transparente para el área de habilidades
            habilidades_surface = pygame.Surface((self.panel_habilidades_rect.width, self.panel_habilidades_rect.height), pygame.SRCALPHA)
            habilidades_surface.fill((0, 0, 0, 0))  # Completamente transparente
            
            start_x_habilidad = 20
            start_y_habilidad = 45  # Ajustado para glassmorphism
